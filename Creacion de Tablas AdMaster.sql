...
CREATE TABLE PublicacionDatosBase	(
		...
		DetalleTiendas						VARCHAR(3000) 	NULL,
		...
		Caracteristica1						VARCHAR(300) 	NULL,
		Caracteristica2						VARCHAR(300) 	NULL,
		Caracteristica3						VARCHAR(300) 	NULL,
		Variable							VARCHAR(300) 	NULL

	)
CREATE 	UNIQUE INDEX PK_PublicacionDatosBase 			ON PublicacionDatosBase (PublicacionId, ConsecutivoId );
...
CREATE 	UNIQUE INDEX PK_PublicacionDatosBaseHistoria		ON PublicacionDatosBaseHistoria (HistoriaId,	PublicacionId, ConsecutivoId );
CREATE  	  INDEX PK_PK_PublicacionDatosBaseHistoria_DetallesId 	ON PublicacionDatosBaseHistoria (DetallesId );	
...
-----.....................................................................---------
CREATE TABLE EXCEL_PUBLICACIONDATOSBASE	(
		TRANSACTIONID						BIGINT,
		OfertaExcelId						BIGINT,
		PublicacionId						BIGINT, 
		ConsecutivoId						BIGINT, 
...
CREATE UNIQUE INDEX PK_EXCEL_PUBLICACIONDATOSBASE ON EXCEL_PUBLICACIONDATOSBASE (TRANSACTIONID, OfertaExcelId);
...
udp_Oferta_ProcesaExcel_Ofertas_Multiformato_Obtiene_PromEmergente_pro			--- ANTES udp_Oferta_ProcesaExcel_Ofertas_Multiformato_Obtiene_PromPub_pro
